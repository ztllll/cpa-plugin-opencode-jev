// Package main implements the opencode-jev CLIProxyAPI plugin.
//
// Exposes the OpenCode Jev System One decision API
// (https://opencode.ai/zen/v1/systemone) through a CPA management route,
// rotating across the OpenCode Go subscription keys already configured in CPA
// so callers get key rotation and retry for free. Jev is not a chat model: it
// evaluates a state against typed questions (noul / choice / score) and
// returns values and probabilities.
package main
